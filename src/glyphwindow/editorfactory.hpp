...
class QtAxisFactoryPrivate;
class QtAxisFactory : public QtAbstractEditorFactory<QtDoublePropertyManager>
{
    Q_OBJECT
public:
    QtAxisFactory(QObject *parent = 0);
    ~QtAxisFactory();
protected:
...
private:
    QScopedPointer<QtAxisFactoryPrivate> d_ptr;
    Q_DECLARE_PRIVATE(QtAxisFactory)
    Q_DISABLE_COPY(QtAxisFactory)
