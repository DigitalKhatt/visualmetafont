...
static int new_script_from_tag(lua_State *L) {
  Tag* tp = (Tag *)luaL_checkudata(L, 1, "dkharfbuzz.Tag");
...
static int script_to_string(lua_State *L) {
  Script *script = (Script *)luaL_checkudata(L, 1, "dkharfbuzz.Script");
  char s[5];
...
static int script_equals(lua_State *L) {
  Script* lhs = (Script *)luaL_checkudata(L, 1, "dkharfbuzz.Script");
  Script* rhs = (Script *)luaL_checkudata(L, 2, "dkharfbuzz.Script");
...
int dk_register_script(lua_State *L) {
  return dk_register_class(L, "dkharfbuzz.Script", script_methods, script_functions, NULL);
}
