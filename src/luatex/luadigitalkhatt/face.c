...
static int face_new(lua_State *L) {
  ...
  if (blob == hb_blob_get_empty() || face == hb_face_get_empty()) {
    ...
    *f = face;
    luaL_getmetatable(L, "dkharfbuzz.Face");
...
static int face_get_glyph_count(lua_State *L) {
  Face *f = (Face *)luaL_checkudata(L, 1, "dkharfbuzz.Face");
...
static int face_get_name(lua_State *L) {
  ...
  if (lua_gettop(L) > 2)
    lang = *((Language*)luaL_checkudata(L, 3, "dkharfbuzz.Language"));
...
static int face_get_table(lua_State *L) {
  Face *f = (Face *)luaL_checkudata(L, 1, "dkharfbuzz.Face");
  Tag *t = (Tag *)luaL_checkudata(L, 2, "dkharfbuzz.Tag");
  Blob *b;
...
static int face_ot_layout_get_script_tags(lua_State *L) {
  ...
  Tag *table = (Tag *)luaL_checkudata(L, 2, "dkharfbuzz.Tag");
...
static int face_ot_layout_find_script(lua_State *L) {
  Face *face = (Face *)luaL_checkudata(L, 1, "dkharfbuzz.Face");
  Tag *table = (Tag *)luaL_checkudata(L, 2, "dkharfbuzz.Tag");
  Tag *script = (Tag *)luaL_checkudata(L, 3, "dkharfbuzz.Tag");
...
static int face_ot_layout_find_language(lua_State *L) {
  ...
  Tag *table = (Tag *)luaL_checkudata(L, 2, "dkharfbuzz.Tag");
  unsigned int script_index = (unsigned int) luaL_checkinteger(L, 3);
  Tag *language = (Tag *)luaL_checkudata(L, 4, "dkharfbuzz.Tag");
  unsigned int index = 0;
...
static int face_ot_layout_find_feature(lua_State *L) {
  ...
  unsigned int script_index = (unsigned int) luaL_checkinteger(L, 3);
  unsigned int language_index = (unsigned int) luaL_checkinteger(L, 4);
  Tag *feature = (Tag *)luaL_checkudata(L, 5, "dkharfbuzz.Tag");
  unsigned int index = 0;
...
int dk_register_face(lua_State *L) {
  return dk_register_class(L, "dkharfbuzz.Face", face_methods, face_functions, NULL);
}
