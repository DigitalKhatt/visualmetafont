...
static int buffer_new(lua_State *L) {
  ...
  luaL_getmetatable(L, "dkharfbuzz.Buffer");
...
static int buffer_guess_segment_properties(lua_State *L) {
  Buffer *b = (Buffer *)luaL_checkudata(L, 1, "dkharfbuzz.Buffer");
...
static int buffer_get_direction(lua_State *L) {
  ...
  luaL_getmetatable(L, "dkharfbuzz.Direction");
  lua_setmetatable(L, -2);
...
static int buffer_set_direction(lua_State *L) {
  Buffer *b = (Buffer *)luaL_checkudata(L, 1, "dkharfbuzz.Buffer");
  Direction* dir = (Direction *)luaL_checkudata(L, 2, "dkharfbuzz.Direction");
...
static int buffer_set_language(lua_State *L) {
  Buffer *b = (Buffer *)luaL_checkudata(L, 1, "dkharfbuzz.Buffer");
  Language *lang = (Language *)luaL_checkudata(L, 2, "dkharfbuzz.Language");
...
static int buffer_set_script(lua_State *L) {
  Buffer *b = (Buffer *)luaL_checkudata(L, 1, "dkharfbuzz.Buffer");
  Script *script = (Script *)luaL_checkudata(L, 2, "dkharfbuzz.Script");
...
static int buffer_get_glyphs(lua_State *L) {
  Buffer *buf = (Buffer *)luaL_checkudata(L, 1, "dkharfbuzz.Buffer");
...
int dk_register_buffer(lua_State *L) {
  return dk_register_class(L, "dkharfbuzz.Buffer", buffer_methods, buffer_functions, buffer_constants);
}
