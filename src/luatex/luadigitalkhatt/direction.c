...
static int direction_to_string(lua_State *L) {
  Direction* d = (Direction *)luaL_checkudata(L, 1, "dkharfbuzz.Direction");
...
static int direction_equals(lua_State *L) {
  Direction* lhs = (Direction *)luaL_checkudata(L, 1, "dkharfbuzz.Direction");
  Direction* rhs = (Direction *)luaL_checkudata(L, 2, "dkharfbuzz.Direction");
...
int dk_register_direction(lua_State *L) {
  return dk_register_class(L, "dkharfbuzz.Direction", direction_methods, direction_functions, NULL);
}
