...
CalcAnchor  digitalkhatt::getanchorCalcFunctions(QString functionName, Subtable* subtable) {
...
Lookup* digitalkhatt::defaultwaqfmarktobase() {
  Lookup* lookup = new Lookup(m_layout);
...
Lookup* digitalkhatt::defaultdotmarks() {
  Lookup* lookup = new Lookup(m_layout);
...
Lookup* digitalkhatt::defaultmkmk() {
...
Lookup* digitalkhatt::defaultmarkdotmarks() {
  Lookup* lookup = new Lookup(m_layout);
...
Lookup* digitalkhatt::defaultwaqfmarkabovemarkprecise() {
  Lookup* lookup = new Lookup(m_layout);
...
Lookup* digitalkhatt::pointmarks() {
...
Lookup* digitalkhatt::shrinkstretchlt() {
...
Lookup* digitalkhatt::shrinkstretchlt(float lt, QString featureName) {
...
Lookup* digitalkhatt::forsmallhighwaw() {
...
Lookup* digitalkhatt::forsmalllalef() {
...
Lookup* digitalkhatt::populatecvxx() {
  int cvNumber = 1;
