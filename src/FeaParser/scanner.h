...
#define	YY_DECL						\
    int				\
    feayy::Scanner::lex(				\
	feayy::Parser::semantic_type* yylval,		\
	feayy::Parser::location_type* yylloc,		\
	feayy::Driver & driver		\
    )
#endif

#ifndef __FLEX_LEXER_H
#define yyFlexLexer FeaFlexLexer
#include "FlexLexer.h"
#undef yyFlexLexer
#endif
...
namespace feayy {
	...
	class Scanner : public FeaFlexLexer
	{
	public:
