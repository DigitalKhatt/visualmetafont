...
GraphicsViewAdjustment::GraphicsViewAdjustment(bool isDark, QWidget* parent)
    : GraphicsViewAdjustment(isDark, NULL, parent) {
}
GraphicsViewAdjustment::GraphicsViewAdjustment(bool isDark, QGraphicsScene* scene, QWidget* parent)
    : isDark(isDark), QGraphicsView(scene, parent) {
