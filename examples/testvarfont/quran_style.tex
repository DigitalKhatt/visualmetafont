...
\newdimen\scaledsize 
\scaledsize=0.06172839506172839506172839506173\textwidth%1/16.2 = 5.29mm
%\showthe\scaledsize

%\font\medinafont={file:digitalkhatt.otf:mode=digitalkhatt;shaper=ot;script=arab}
%\font\medinafontnode={file:digitalkhatt.otf:script=arab}
%\font\medinafontvar={file:digitalkhatt-cff2.otf:mode=digitalkhatt;shaper=ot;script=arab;variableshapes;axis={ltat=5,rtat=5}}
\font\medinafontvar={file:digitalkhatt-cff2.otf:mode=digitalkhatt;shaper=ot;script=arab;variableshapes;colr;tjwd;-fixedspace} at 5.29mm %5.27mm at \scaledsize
