...
do
    ...
    function otf.pluginprocessor(head,font,dynamic,direction,nofused,groupcode,size,packtype) -- n
        ...
        if p then
            ...
            return p[2](head,font,dynamic,direction,nofused,groupcode,size,packtype)
        else
            return head, false
        end
    end
