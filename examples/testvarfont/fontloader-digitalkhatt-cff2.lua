if not modules then modules = { } end modules ['font-cff2-digitalkhatt'] = {
    version   = 1.001,
    optimize  = true,
...
digitalkhatt.parsecharstrings = parsecharstrings -- used in font-onr.lua (type 1)
...
function readers.dkcff2(f,fontdata,specification)
